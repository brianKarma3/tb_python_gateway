...
class CustomMqttUplinkConverter_habs(MqttUplinkConverter):
    ...
    def convert(self, topic, body):
        try:
            ...
            self.dict_result["deviceType"] = "Hab_controller"  # just hardcode this
            ...
            if self.__config.get("extension-config") is not None:
                ...
                self.dict_result["telemetry"] = [{data_type: body}]  # if no specific configuration in config file - just send data which received
